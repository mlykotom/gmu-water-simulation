...
//    gpu_device = devices.at(0);
//
//    qDebug()<< "Selected device: " << gpu_device.getInfo<CL_DEVICE_NAME>(&err_msg).c_str();
//
...
//    * =======================================================
//    */
//    cl::Buffer a_buffer(context, CL_MEM_READ_WRITE, sizeof(cl_int) * MATRIX_W * MATRIX_H, &err);
//
//    if (err)
//    {
...
//    }
//
//    cl::Buffer b_buffer(context, CL_MEM_READ_WRITE, sizeof(cl_int) * MATRIX_W * MATRIX_H, &err);
//
//    if (err)
//    {
...
//    }
//
//    cl::Buffer c_buffer(context, CL_MEM_READ_WRITE, sizeof(cl_int) * MATRIX_W * MATRIX_H, &err);
//
//    if (err)
//    {
